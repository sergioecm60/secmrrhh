...
<head>
    <meta charset="UTF-8">
    <title>Gestionar Modalidades de Contrato - SECM RRHH</title>
...
<div class="container main-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalContrato"><i class="bi bi-plus-circle"></i> Nueva Modalidad</button>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Nueva Modalidad de Contrato</h5>
...
$(document).ready(function() {
    ...
    const modal = $('#modalContrato');

    function cargarDatos() {
        // manage=true para obtener activos e inactivos
                ...
                res.data.forEach(item => {
                    ...
                    html += `<tr>
                        ...
                        <td class="d-flex gap-1">
                            ...
                            <button class="btn btn-sm btn-danger delete-item" data-id="${item.id_modalidad}"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>`;
                });
            }
            $('#data-list').html(html || '<tr><td colspan="5" class="text-center">No hay modalidades de contrato definidas.</td></tr>');
        });
    }
    ...
    $(document).on('click', '.edit-item', function() {
        ...
        modal.find('.modal-title').text('Editar Modalidad de Contrato');
        $('#data-id').val(itemData.id_modalidad);
    ...
    modal.on('hidden.bs.modal', () => { 
        ...
        $('#data-id').val(''); 
        modal.find('.modal-title').text('Nueva Modalidad de Contrato'); 
